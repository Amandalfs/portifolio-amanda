...
export default function MenuSection() {
    ...
    >   
        <ul className="flex flex-col gap-6 text-right">
            ...
            <li className="text-textSecondary-light dark:text-textSecondary-dark text-xs">Sobre mim</li>
            <li className="text-textSecondary-light dark:text-textSecondary-dark text-xs">Projetos</li>
            <li className="text-textSecondary-light dark:text-textSecondary-dark text-xs">Contatos</li> 
        </ul>
